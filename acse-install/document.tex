...
\begin{enumerate}
    ...
    \item In Windows, open Explorer and type \verb+\\wsl$\<DISTRO_NAME>+ in the search bar (for example: \verb+\\wsl$\Ubuntu+) and press \keys{\enter}. Use this Virtual Server to access Linux folders.
  \end{enumerate}
